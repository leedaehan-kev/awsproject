...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-^qjf-9h8_1^ois3m+%hj8r%5ovcqku%ng)d8#6o4b02xnu-1oy')
...
DATABASES = {
   'default': {
        ...
        'USER': 'sanhak',
        'PASSWORD': 'sanhak1234',
        'HOST': 'sanhakdb.cjsudwjytimp.ap-northeast-2.rds.amazonaws.com',
        'PORT': '3306',
        'OPTIONS': {
...
# AWS_STORAGE_BUCKET_NAME = 'bucket0ryu'
